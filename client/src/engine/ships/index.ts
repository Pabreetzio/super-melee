...
const SHIPS: ShipDef[] = [
  ...
  { id: 'umgah',      name: 'Umgah Drone',         crew: 10, energy: 30, speed: 18, turnRate: 1, thrustDelay: 3, turnDelay: 4, mass: 1, radius: 16, primaryDamage: 1, secondaryDamage: 0 },
  ...
  { id: 'zoqfotpik',  name: 'Zoq-Fot-Pik Stinger', crew: 10, energy: 10, speed: 40, turnRate: 1, thrustDelay: 0, turnDelay: 1, mass: 5, radius: 10, primaryDamage: 1, secondaryDamage: 12 },
